...
*
* Best2Pay payment plugin for VirtueMart 3
*
...
class plgVmPaymentBest2Pay extends vmPSPlugin {
	...
	function sendTransactionRequest($method, $cart, $order) {
		...
		if (intval($best2pay_id) == 0) {
			JError::raiseWarning(500, var_export($best2pay_id, true));
			return false;
		}
	...
	public function plgVmOnPaymentResponseReceived(&$html) {
		...
		try {
			...
			JError::raiseWarning(500, JText::_('VMPAYMENT_BEST2PAY_ERROR', false));
			$mainframe = JFactory::getApplication();
